            ...
            group(ApiBC)
            {
                ...
                action(CallApiListCompanies)
                {
                    ...
                    begin
                        ...
                        //Vtext := 'CRONUS IN';
                        URl := 'https://api.businesscentral.dynamics.com/v2.0/abc87ed0-4014-486f-afd8-1577c92442a6/KohinoorSandbox/ODataV4/Company(CRONUS IN)/Chart_of_Accounts';
                        // APICallResponse := GenericApiCalls.CreateRequest(ApiListCompanies, AccessTokenForBC);
                        APICallResponse := GenericApiCalls.CreateRequest(URl, AccessTokenForBC);
                        Message(APICallResponse);
                    end;
                }
            }
