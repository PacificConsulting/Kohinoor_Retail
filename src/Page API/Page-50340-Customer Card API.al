page 50340 "Customer Card API"
{
    APIGroup = 'CustomerGroup';
    APIPublisher = 'Pacific';
    APIVersion = 'v1.0';
    ApplicationArea = All;
    Caption = 'customerCardAPI';
    DelayedInsert = true;
    EntityName = 'CustomerCard';
    EntitySetName = 'CustomerCards';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field(aggregateTurnover; Rec."Aggregate Turnover")
                {
                ...
                field(eCommerceOperator; Rec."E-Commerce Operator")
                {
                ...
                field(gstRegistrationType; Rec."GST Registration Type")
                {
                ...
                field(pANReferenceNo; Rec."P.A.N. Reference No.")
                {
                    Caption = 'P.A.N. Reference No.';
                }
                field(pANStatus; Rec."P.A.N. Status")
                {
